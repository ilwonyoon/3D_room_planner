...
const INITIAL_OBJECTS: EditorObject[] = [
  ...
  },
  {
    id: 'storage-right',
    label: 'File Cabinet',
    url: modelUrlWithBestVariant('/assets/models/sharetextures/sharetextures-cabinet-3.optimized.glb'),
    renderKind: 'model',
    position: { x: 1.48, z: -1.62 },
    placement: 'floor',
    elevationM: 0.02,
    rotationY: 0,
    targetSize: 1.12,
    dimensionsM: { x: 0.377, y: 1.12, z: 0.377 },
  },
  {
    id: 'reading-lamp',
    label: 'Floor Lamp',
