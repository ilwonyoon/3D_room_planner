...
const INITIAL_OBJECTS: EditorObject[] = [
  {
    id: 'desk',
    label: '70/70 Table',
    ...modelAsset('/assets/models/manual/muuto-70-70-table-474168187272003.optimized.glb'),
    catalogItemId: 'muuto-70-70-table-474168187272003',
    productCategory: 'table',
    renderKind: 'model',
    position: { x: 0.24, z: -2.08 },
    placement: 'floor',
    elevationM: 0.02,
    rotationY: 0,
    targetSize: 1.68,
    dimensionsM: { x: 1.68, y: 0.73, z: 0.82 },
    locked: true,
  },
  {
    id: 'armchair',
    label: 'Wire Chair DKL 2',
    ...modelAsset('/assets/models/manual/vitra-wire-chair-dkl-2-with-seat-and-backrest-upholstery-9777324.optimized.glb'),
    catalogItemId: 'vitra-wire-chair-dkl-2-with-seat-and-backrest-upholstery-9777324',
    productCategory: 'chair',
    renderKind: 'model',
    position: { x: 0.24, z: -1.08 },
    placement: 'floor',
    elevationM: 0.02,
    rotationY: Math.PI,
    boundsRotationY: Math.PI,
    targetSize: 0.92,
    dimensionsM: { x: 0.58, y: 0.92, z: 0.56 },
  },
  {
    id: 'desk-lamp',
    label: 'Quille Desk Lamp',
    ...modelAsset('/assets/models/manual/designconnected-quille-desk-lamp-8203.optimized.glb'),
    catalogItemId: 'designconnected-quille-desk-lamp-8203',
    productCategory: 'lighting',
    renderKind: 'model',
    position: { x: 0.8, z: -2.22 },
    placement: 'floor',
    elevationM: 0.742,
    rotationY: Math.PI / 2,
    targetSize: 0.42,
    dimensionsM: { x: 0.2, y: 0.42, z: 0.2 },
    locked: true,
  },
  {
    id: 'imac-desk-setup',
  ...
  {
    id: 'storage-right',
    label: 'Nelson Basic Cabinet Series',
    ...modelAsset('/assets/models/manual/herman-miller-nelson-basic-cabinet-series.optimized.glb'),
    catalogItemId: 'herman-miller-nelson-basic-cabinet-series',
    productCategory: 'storage',
    renderKind: 'model',
    position: { x: 2.08, z: -2.2 },
    placement: 'floor',
    elevationM: 0.02,
    rotationY: 0,
    targetSize: 0.92,
    dimensionsM: { x: 0.72, y: 0.92, z: 0.56 },
  },
  {
    id: 'office-rug',
  ...
  },
  {
    ...
    label: 'Couple Coffee Table',
    ...modelAsset('/assets/models/polyhaven/modern_coffee_table_02.optimized.glb'),
    catalogItemId: 'modern_coffee_table_02',
    productCategory: 'table',
    renderKind: 'model',
    ...
    rotationY: 0,
    targetSize: 1.1,
    dimensionsM: { x: 1.1, y: 0.36, z: 0.7 },
    locked: true,
  },
  {
  ...
  },
  {
    ...
    label: 'Nelson Cabinet Book Stack',
    ...modelAsset('/assets/models/polyhaven/book_encyclopedia_set_01.optimized.glb'),
    catalogItemId: 'book_encyclopedia_set_01',
    productCategory: 'decor',
    renderKind: 'model',
    position: { x: 1.88, z: -2.04 },
    placement: 'floor',
    elevationM: 0.94,
    rotationY: -Math.PI / 8,
    targetSize: 0.24,
  ...
  {
    id: 'back-wall-print',
    label: 'Back Wall Print',
    url: '/procedural/wall-art-right',
    catalogItemId: 'hanging_picture_frame_03',
    productCategory: 'decor',
    renderKind: 'wall-art',
    position: { x: 1.86, z: -2.835 },
    placement: 'wall',
    elevationM: 1.25,
    rotationY: 0,
    boundsRotationY: 0,
  ...
  },
  {
    ...
    ...modelAsset('/assets/models/manual/zeel-by-furniture-blown-armchair.optimized.glb'),
  ...
  },
  {
    ...
    label: 'Tray Table Medium',
    ...modelAsset('/assets/models/polyhaven/side_table_tall_01.optimized.glb'),
    catalogItemId: 'side_table_tall_01',
    productCategory: 'table',
    renderKind: 'model',
    ...
    rotationY: 0,
    targetSize: 0.54,
    dimensionsM: { x: 0.42, y: 0.54, z: 0.42 },
  },
  {
