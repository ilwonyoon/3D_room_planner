...
const baseModelSeedsByCategory: Record<ProductCategory, ProductCatalogSeed[]> = {
  ...
  storage: [
    ...
    { id: 'herman-miller-nelson-basic-cabinet-series', source: 'manual', dimensionsCm: [72, 56, 92] },
...
const retailAliasById: Record<string, ProductRetailAlias> = {
  ...
  'herman-miller-nelson-basic-cabinet-series': { brand: 'Herman Miller', name: 'Nelson Basic Cabinet Series' },
