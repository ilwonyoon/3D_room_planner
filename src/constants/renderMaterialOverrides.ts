...
const materialRules: RenderMaterialRule[] = [
  ...
  {
    id: 'textured-office-desk',
    objectIds: ['desk'],
    modelUrlIncludes: ['metal_office_desk'],
    tuning: {
      envMapIntensity: 0.58,
      roughnessMin: 0.58,
      roughnessMax: 0.82,
  ...
  {
    id: 'muuto-7070-work-desk',
    objectIds: ['desk'],
    modelUrlIncludes: ['muuto-70-70-table'],
    tuning: {
      baseColor: '#bdb6aa',
  ...
  },
  {
    ...
    modelUrlIncludes: ['rounded-commode', 'rounded-cabinet'],
    tuning: {
      baseColor: '#e0d7ca',
